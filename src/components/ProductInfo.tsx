    ...
    <div className="pi-container">
      <div>
        ...
        <div className="pi-header-container">
          ...
          <span className="pi-rating" style={{ color: (product.rating || 0) > 0 ? '#FFD700' : 'var(--color-text-muted)' }} title={`${product.reviewsCount || 0} reseña${product.reviewsCount !== 1 ? 's' : ''}`}>
        ...
        <div className="pi-meta-container">
