...
export default function MiNegocioPage() {
  ...
  return (
    <div className="container-page" style={customStyles}>
      ...
      {/* Limits indicator */}
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'flex-end', gap: '12px', marginBottom: '24px' }}>
      ...
      <div className="glass-panel relative p-0 rounded-[var(--radius-lg)]">
        ...
        <div style={{ position: 'relative', padding: '0 20px 20px 20px', zIndex: 20 }}>
          ...
          {/* Description & Tags */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '40px', position: 'relative', padding: '24px', background: 'var(--color-bg-surface-elevated)', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-md)', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
              ...
              <div style={{ position: 'relative', paddingBottom: '40px' }}>
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px', marginBottom: '24px' }}>
                    ...
                    <EditButton onClick={() => router.push('/configuracion')} style={{ position: 'static' }} label="Editar en Configuración" />
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', color: 'var(--color-text-main)', fontSize: '1.05rem', maxWidth: '600px' }}>
